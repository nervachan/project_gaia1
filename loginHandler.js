        ...
        .then(([buyerSnapshot, sellerSnapshot]) => {
            ...
            return setPersistence(auth, browserLocalPersistence)
              ...
              .then((userCredential) => {
                  ...
                  if (userType === "buyer") {
                    window.location.href = '/src/buyer-side/buyer-login.html'; // Corrected redirect for buyer
                  } else if (userType === "seller") {
                    window.location.href = '/src/seller-side/seller-hub-main.html'; // Corrected redirect for seller
                  }
